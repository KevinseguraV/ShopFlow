...
export const getProductsRequest = async (page = 0, size = 12, sort = "createdAt") => {
...
export const searchProductsRequest = async (query, page = 0, size = 12) => {
  const response = await api.get(
...
export const getProductsByCategoryRequest = async (categoryId, page = 0, size = 12) => {
  const response = await api.get(
